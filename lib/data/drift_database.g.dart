...
class $AppSettingsTable extends AppSettings
  ...
  static const VerificationMeta _targetWaterMeta = const VerificationMeta(
    'targetWater',
  );
  @override
  ...
  AppSetting map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return AppSetting(
      ...
      targetWater: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
...
class $ExercisesTable extends Exercises
  ...
  Exercise map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Exercise(
      ...
      musclesPrimary: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
...
class Exercise extends DataClass implements Insertable<Exercise> {
  ...
  Exercise copyWith({
    ...
    musclesPrimary: musclesPrimary.present
...
class RoutineExercise extends DataClass implements Insertable<RoutineExercise> {
  ...
  RoutineExercise copyWith({
    ...
    pauseSeconds: pauseSeconds.present ? pauseSeconds.value : this.pauseSeconds,
  );
...
class $RoutineSetTemplatesTable extends RoutineSetTemplates
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<RoutineSetTemplate> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
...
class RoutineSetTemplate extends DataClass
  ...
  factory RoutineSetTemplate.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
class $SetLogsTable extends SetLogs with TableInfo<$SetLogsTable, SetLog> {
  ...
  static const VerificationMeta _logOrderMeta = const VerificationMeta(
    'logOrder',
  );
  @override
  ...
  SetLog map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return SetLog(
      ...
      logOrder: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}log_order'],
      )!,
...
class $CardioActivitiesTable extends CardioActivities
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<CardioActivity> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
...
class CardioActivity extends DataClass implements Insertable<CardioActivity> {
  ...
  factory CardioActivity.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
class $CardioSamplesTable extends CardioSamples
  ...
  static const VerificationMeta _cardioActivityIdMeta = const VerificationMeta(
    'cardioActivityId',
  );
  @override
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<CardioSample> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  CardioSample map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return CardioSample(
      ...
      cardioActivityId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}cardio_activity_id'],
      )!,
...
class $ProductsTable extends Products with TableInfo<$ProductsTable, Product> {
  ...
  static const VerificationMeta _caffeineMeta = const VerificationMeta(
    'caffeine',
  );
  @override
  ...
  Product map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Product(
      ...
      caffeine: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}caffeine'],
      ),
...
class $NutritionLogsTable extends NutritionLogs
  ...
  static const VerificationMeta _legacyBarcodeMeta = const VerificationMeta(
    'legacyBarcode',
  );
  @override
  ...
  NutritionLog map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return NutritionLog(
      ...
      legacyBarcode: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}legacy_barcode'],
      ),
...
class NutritionLog extends DataClass implements Insertable<NutritionLog> {
  ...
  NutritionLog copyWith({
    ...
    legacyBarcode: legacyBarcode.present
        ? legacyBarcode.value
        : this.legacyBarcode,
...
class SupplementLog extends DataClass implements Insertable<SupplementLog> {
  ...
  factory SupplementLog.fromJson(
    ...
    return SupplementLog(
      ...
      amount: serializer.fromJson<double>(json['amount']),
      sourceNutritionLogId: serializer.fromJson<String?>(
        json['sourceNutritionLogId'],
      ),
    );
  }
  @override
...
class SupplementLogsCompanion extends UpdateCompanion<SupplementLog> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (sourceNutritionLogId.present) {
      map['source_nutrition_log_id'] = Variable<String>(
        sourceNutritionLogId.value,
      );
    }
    return map;
...
class $FluidLogsTable extends FluidLogs
  ...
  static const VerificationMeta _sugarPer100mlMeta = const VerificationMeta(
    'sugarPer100ml',
  );
  @override
  ...
  static const VerificationMeta _caffeinePer100mlMeta = const VerificationMeta(
    'caffeinePer100ml',
  );
  @override
  ...
  FluidLog map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return FluidLog(
      ...
      sugarPer100ml: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}sugar_per100ml'],
      ),
      caffeinePer100ml: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}caffeine_per100ml'],
      ),
...
class FluidLog extends DataClass implements Insertable<FluidLog> {
  ...
  factory FluidLog.fromJson(
    ...
    return FluidLog(
      ...
      linkedNutritionLogId: serializer.fromJson<String?>(
        json['linkedNutritionLogId'],
      ),
    );
  }
  @override
  ...
  FluidLog copyWith({
    ...
    name: name ?? this.name,
    kcal: kcal.present ? kcal.value : this.kcal,
    sugarPer100ml: sugarPer100ml.present
        ? sugarPer100ml.value
        : this.sugarPer100ml,
...
class FluidLogsCompanion extends UpdateCompanion<FluidLog> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (linkedNutritionLogId.present) {
      map['linked_nutrition_log_id'] = Variable<String>(
        linkedNutritionLogId.value,
      );
    }
    return map;
...
class $MeasurementsTable extends Measurements
  ...
  static const VerificationMeta _legacySessionIdMeta = const VerificationMeta(
    'legacySessionId',
  );
  @override
  ...
  Measurement map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Measurement(
      ...
      legacySessionId: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}legacy_session_id'],
      ),
    );
  }
...
class $SocialInteractionsTable extends SocialInteractions
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<SocialInteraction> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
...
class SocialInteraction extends DataClass
  ...
  factory SocialInteraction.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
class $FoodCategoriesTable extends FoodCategories
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<FoodCategory> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
...
class DailyGoalsHistoryData extends DataClass
  ...
  factory DailyGoalsHistoryData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
class $SupplementSettingsHistoryTable extends SupplementSettingsHistory
  ...
  Set<GeneratedColumn> get $primaryKey => {localId};
  @override
  SupplementSettingsHistoryData map(
...
class SupplementSettingsHistoryData extends DataClass
  ...
  factory SupplementSettingsHistoryData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $CardioActivitiesTable cardioActivities = $CardioActivitiesTable(
    this,
  );
  ...
  StreamQueryUpdateRules get streamUpdateRules => const StreamQueryUpdateRules([
    ...
    WritePropagation(
      ...
      result: [TableUpdate('routine_set_templates', kind: UpdateKind.delete)],
    ),
    WritePropagation(
      on: TableUpdateQuery.onTableName(
        'workout_logs',
    ...
    WritePropagation(
      ...
      result: [TableUpdate('cardio_activities', kind: UpdateKind.delete)],
    ),
    WritePropagation(
      on: TableUpdateQuery.onTableName(
        'cardio_activities',
      ...
      result: [TableUpdate('cardio_samples', kind: UpdateKind.delete)],
    ),
    WritePropagation(
      on: TableUpdateQuery.onTableName(
        'supplements',
    ...
    WritePropagation(
      ...
      result: [TableUpdate('supplement_logs', kind: UpdateKind.update)],
    ),
    WritePropagation(
      on: TableUpdateQuery.onTableName(
        'nutrition_logs',
      ...
      result: [TableUpdate('fluid_logs', kind: UpdateKind.delete)],
    ),
    WritePropagation(
      on: TableUpdateQuery.onTableName(
        'posts',
      ...
      result: [TableUpdate('social_interactions', kind: UpdateKind.delete)],
    ),
    WritePropagation(
      on: TableUpdateQuery.onTableName(
        'meals',
    ...
    WritePropagation(
      ...
      result: [
        TableUpdate('supplement_settings_history', kind: UpdateKind.delete),
      ],
    ),
  ]);
}
...
final class $$ProfilesTableReferences
  ...
  _appSettingsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.appSettings,
    aliasName: $_aliasNameGenerator(db.profiles.id, db.appSettings.userId),
  );
...
final class $$RoutinesTableReferences
  ...
  _workoutLogsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.workoutLogs,
    aliasName: $_aliasNameGenerator(db.routines.id, db.workoutLogs.routineId),
  );
...
final class $$RoutineExercisesTableReferences
  ...
  static MultiTypedResultKey<
    ...
    List<RoutineSetTemplate>
  >
  _routineSetTemplatesRefsTable(_$AppDatabase db) =>
      MultiTypedResultKey.fromTable(
        db.routineSetTemplates,
        aliasName: $_aliasNameGenerator(
  ...
  $$RoutineSetTemplatesTableProcessedTableManager get routineSetTemplatesRefs {
    final manager =
        $$RoutineSetTemplatesTableTableManager(
          $_db,
          $_db.routineSetTemplates,
        ).filter(
          (f) => f.routineExerciseId.id.sqlEquals($_itemColumn<String>('id')!),
        );

    final cache = $_typedResult.readTableOrNull(
      _routineSetTemplatesRefsTable($_db),
    );
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
...
class $$RoutineExercisesTableAnnotationComposer
  ...
  Expression<T> routineSetTemplatesRefs<T extends Object>(
    Expression<T> Function($$RoutineSetTemplatesTableAnnotationComposer a) f,
  ) {
...
final class $$RoutineSetTemplatesTableReferences
    extends
        BaseReferences<
          _$AppDatabase,
          $RoutineSetTemplatesTable,
...
class $$RoutineSetTemplatesTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $RoutineSetTemplatesTable,
  ...
  $$RoutineSetTemplatesTableTableManager(
    _$AppDatabase db,
    $RoutineSetTemplatesTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
...
typedef $$RoutineSetTemplatesTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $RoutineSetTemplatesTable,
      RoutineSetTemplate,
...
final class $$WorkoutLogsTableReferences
  ...
  static MultiTypedResultKey<$SetLogsTable, List<SetLog>> _setLogsRefsTable(
    ...
    db.setLogs,
    aliasName: $_aliasNameGenerator(db.workoutLogs.id, db.setLogs.workoutLogId),
  );
  ...
  _cardioActivitiesRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.cardioActivities,
    aliasName: $_aliasNameGenerator(
      db.workoutLogs.id,
      db.cardioActivities.workoutLogId,
    ),
  );

  $$CardioActivitiesTableProcessedTableManager get cardioActivitiesRefs {
    final manager = $$CardioActivitiesTableTableManager(
      $_db,
      $_db.cardioActivities,
    ).filter((f) => f.workoutLogId.id.sqlEquals($_itemColumn<String>('id')!));

    final cache = $_typedResult.readTableOrNull(
      _cardioActivitiesRefsTable($_db),
    );
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
...
final class $$CardioActivitiesTableReferences
    extends
  ...
  _cardioSamplesRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.cardioSamples,
    aliasName: $_aliasNameGenerator(
      db.cardioActivities.id,
      db.cardioSamples.cardioActivityId,
    ),
  );
  ...
  $$CardioSamplesTableProcessedTableManager get cardioSamplesRefs {
    final manager = $$CardioSamplesTableTableManager($_db, $_db.cardioSamples)
        .filter(
          (f) => f.cardioActivityId.id.sqlEquals($_itemColumn<String>('id')!),
        );
...
class $$CardioActivitiesTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
...
typedef $$CardioActivitiesTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $CardioActivitiesTable,
      CardioActivity,
      ...
      PrefetchHooks Function({bool workoutLogId, bool cardioSamplesRefs})
    >;
typedef $$CardioSamplesTableCreateCompanionBuilder =
    CardioSamplesCompanion Function({
      Value<int> localId,
      Value<String> id,
      Value<DateTime> createdAt,
      Value<DateTime> updatedAt,
...
typedef $$CardioSamplesTableUpdateCompanionBuilder =
    CardioSamplesCompanion Function({
      Value<int> localId,
      Value<String> id,
      Value<DateTime> createdAt,
...
final class $$CardioSamplesTableReferences
  ...
  static $CardioActivitiesTable _cardioActivityIdTable(_$AppDatabase db) =>
      db.cardioActivities.createAlias(
        $_aliasNameGenerator(
          db.cardioSamples.cardioActivityId,
          db.cardioActivities.id,
        ),
...
class $$CardioSamplesTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $CardioSamplesTable,
...
typedef $$CardioSamplesTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $CardioSamplesTable,
      CardioSample,
...
final class $$ProductsTableReferences
  ...
  _nutritionLogsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.nutritionLogs,
    aliasName: $_aliasNameGenerator(db.products.id, db.nutritionLogs.productId),
  );
  ...
  _mealItemsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.mealItems,
    aliasName: $_aliasNameGenerator(db.products.id, db.mealItems.productId),
  );
...
final class $$NutritionLogsTableReferences
  ...
  _supplementLogsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    ...
    aliasName: $_aliasNameGenerator(
      db.nutritionLogs.id,
      db.supplementLogs.sourceNutritionLogId,
    ),
  );
...
final class $$SupplementsTableReferences
  ...
  static MultiTypedResultKey<
    $SupplementSettingsHistoryTable,
    List<SupplementSettingsHistoryData>
  >
  _supplementSettingsHistoryRefsTable(_$AppDatabase db) =>
      MultiTypedResultKey.fromTable(
        db.supplementSettingsHistory,
        aliasName: $_aliasNameGenerator(
          db.supplements.id,
          db.supplementSettingsHistory.supplementId,
        ),
      );
  ...
  get supplementSettingsHistoryRefs {
    ...
    final cache = $_typedResult.readTableOrNull(
      _supplementSettingsHistoryRefsTable($_db),
    );
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
...
class $$SupplementsTableFilterComposer
  ...
  Expression<bool> supplementSettingsHistoryRefs(
    Expression<bool> Function($$SupplementSettingsHistoryTableFilterComposer f)
    f,
  ) {
...
class $$SupplementsTableAnnotationComposer
  ...
  Expression<T> supplementSettingsHistoryRefs<T extends Object>(
    Expression<T> Function($$SupplementSettingsHistoryTableAnnotationComposer a)
    f,
  ) {
...
class $$SupplementsTableTableManager
    extends
        RootTableManager<
          ...
          PrefetchHooks Function({
            bool supplementLogsRefs,
            bool supplementSettingsHistoryRefs,
          })
        > {
...
final class $$SupplementLogsTableReferences
  ...
  $$NutritionLogsTableProcessedTableManager? get sourceNutritionLogId {
    ...
    final item = $_typedResult.readTableOrNull(
      _sourceNutritionLogIdTable($_db),
    );
    if (item == null) return manager;
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: [item]),
...
typedef $$SupplementLogsTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function({bool supplementId, bool sourceNutritionLogId})
    >;
typedef $$FluidLogsTableCreateCompanionBuilder =
    FluidLogsCompanion Function({
      Value<int> localId,
      Value<String> id,
      Value<DateTime> createdAt,
      Value<DateTime> updatedAt,
...
typedef $$FluidLogsTableUpdateCompanionBuilder =
    FluidLogsCompanion Function({
      Value<int> localId,
      Value<String> id,
      Value<DateTime> createdAt,
...
final class $$FluidLogsTableReferences
  ...
  $$NutritionLogsTableProcessedTableManager? get linkedNutritionLogId {
    ...
    final item = $_typedResult.readTableOrNull(
      _linkedNutritionLogIdTable($_db),
    );
    if (item == null) return manager;
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: [item]),
...
class $$FluidLogsTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $FluidLogsTable,
...
typedef $$FluidLogsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $FluidLogsTable,
      FluidLog,
...
final class $$PostsTableReferences
  ...
  _socialInteractionsRefsTable(_$AppDatabase db) =>
      MultiTypedResultKey.fromTable(
        db.socialInteractions,
        aliasName: $_aliasNameGenerator(
          db.posts.id,
          db.socialInteractions.postId,
        ),
      );

  $$SocialInteractionsTableProcessedTableManager get socialInteractionsRefs {
    final manager = $$SocialInteractionsTableTableManager(
      $_db,
      $_db.socialInteractions,
    ).filter((f) => f.postId.id.sqlEquals($_itemColumn<String>('id')!));

    final cache = $_typedResult.readTableOrNull(
      _socialInteractionsRefsTable($_db),
    );
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
...
final class $$SocialInteractionsTableReferences
    extends
        BaseReferences<
          _$AppDatabase,
...
class $$SocialInteractionsTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $SocialInteractionsTable,
...
typedef $$SocialInteractionsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $SocialInteractionsTable,
      SocialInteraction,
...
typedef $$MealItemsTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function({bool mealId, bool productId})
    >;
typedef $$FoodCategoriesTableCreateCompanionBuilder =
    FoodCategoriesCompanion Function({
      required String key,
      Value<String?> nameDe,
      Value<String?> nameEn,
      Value<String?> emoji,
...
typedef $$FoodCategoriesTableUpdateCompanionBuilder =
    FoodCategoriesCompanion Function({
      Value<String> key,
      Value<String?> nameDe,
      Value<String?> nameEn,
...
class $$FoodCategoriesTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $FoodCategoriesTable,
...
typedef $$FoodCategoriesTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $FoodCategoriesTable,
      FoodCategory,
...
class $$DailyGoalsHistoryTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
...
typedef $$DailyGoalsHistoryTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $DailyGoalsHistoryTable,
      DailyGoalsHistoryData,
...
final class $$SupplementSettingsHistoryTableReferences
    extends
        BaseReferences<
          _$AppDatabase,
          $SupplementSettingsHistoryTable,
...
class $$SupplementSettingsHistoryTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $SupplementSettingsHistoryTable,
  ...
  $$SupplementSettingsHistoryTableTableManager(
    _$AppDatabase db,
    $SupplementSettingsHistoryTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
