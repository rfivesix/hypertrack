...
abstract class AppLocalizations {
  ...
  /// No description provided for @widgetSettingsEnableTitle.
  ///
  /// In en, this message translates to:
  /// **'Enable Today in focus widget'**
  String get widgetSettingsEnableTitle;

  /// No description provided for @widgetSettingsEnableSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Shows your key daily metrics on the home screen'**
  String get widgetSettingsEnableSubtitle;

  /// No description provided for @widgetSettingsMaxItemsTitle.
  ///
  /// In en, this message translates to:
  /// **'Max visible items'**
  String get widgetSettingsMaxItemsTitle;

  /// No description provided for @widgetSettingsMaxItemsSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Also adapts automatically to widget size'**
  String get widgetSettingsMaxItemsSubtitle;

  /// No description provided for @widgetSettingsChooseMetricsTitle.
  ///
  /// In en, this message translates to:
  /// **'Choose metrics'**
  String get widgetSettingsChooseMetricsTitle;

  /// No description provided for @widgetSettingsChooseMetricsSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Deterministic order matching the daily overview'**
  String get widgetSettingsChooseMetricsSubtitle;

  /// No description provided for @widgetMetricCreatine.
  ///
  /// In en, this message translates to:
  /// **'Creatine'**
  String get widgetMetricCreatine;

  /// No description provided for @widgetMetricSupplements.
  ///
  /// In en, this message translates to:
  /// **'Supplements'**
  String get widgetMetricSupplements;

  /// No description provided for @widgetOpenAppToLoadData.
  ///
  /// In en, this message translates to:
  /// **'Open Hypertrack to load today data'**
  String get widgetOpenAppToLoadData;

  /// No description provided for @widgetUnitKcal.
  ///
  /// In en, this message translates to:
  /// **'kcal'**
  String get widgetUnitKcal;

  /// No description provided for @widgetUnitGramShort.
  ///
  /// In en, this message translates to:
  /// **'g'**
  String get widgetUnitGramShort;

  /// No description provided for @widgetUnitMl.
  ///
  /// In en, this message translates to:
  /// **'ml'**
  String get widgetUnitMl;

  /// No description provided for @widgetUnitMg.
  ///
  /// In en, this message translates to:
  /// **'mg'**
  String get widgetUnitMg;

  /// No description provided for @widgetValueProgress.
  ///
  /// In en, this message translates to:
  /// **'{current} / {target} {unit}'**
  String widgetValueProgress(Object current, Object target, Object unit);

  /// No description provided for @widgetSupplementsProgress.
  ///
  /// In en, this message translates to:
  /// **'{taken} / {total}'**
  String widgetSupplementsProgress(Object taken, Object total);

  /// No description provided for @widgetWorkoutCompletedCount.
  ///
  /// In en, this message translates to:
  /// **'{count} completed'**
  String widgetWorkoutCompletedCount(Object count);

  /// No description provided for @widgetSleepDuration.
  ///
  /// In en, this message translates to:
  /// **'{hours}h {minutes}m'**
  String widgetSleepDuration(Object hours, Object minutes);

  /// No description provided for @widgetSleepWithScore.
  ///
  /// In en, this message translates to:
  /// **'{duration} · {score}'**
