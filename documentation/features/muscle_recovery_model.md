...
2.  **Ready** ($0.6 \le R < 0.9$): Muscle is functional but may have slight remaining soreness or substrate depletion.
3.  **Fresh** ($R \ge 0.9$): Optimal readiness for high-intensity loading.
